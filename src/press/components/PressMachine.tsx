  ...
  return (
    <div className="press-machine" role="img" aria-label="Power, hardware, and compute into an AI machine that prints money">
      <svg viewBox="0 0 600 220" fill="none" role="img" preserveAspectRatio="xMidYMid meet">
        ...
        {/* inputs — each node = tile + icon + label + its flow stub */}
        <g className="pm-in">
          <g className="pm-node">
            <rect className="pm-tile" x="18" y="20" width="150" height="48" rx="8" fill="#101216" stroke="currentColor" strokeOpacity="0.18" />
            <path d="M46 33 L38 46 H45 L41 55" stroke="#c9923a" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
            <text className="pm-label" x="74" y="48" fill="currentColor" fillOpacity="0.5" fontSize="11" fontFamily="ui-monospace,monospace" letterSpacing="0.16em">POWER</text>
            <path className="pm-flow" d="M168 44 H230" stroke="url(#pf)" strokeWidth="1.4" />
          </g>

          <g className="pm-node">
            <rect className="pm-tile" x="18" y="86" width="150" height="48" rx="8" fill="#101216" stroke="currentColor" strokeOpacity="0.18" />
            ...
            <text className="pm-label" x="74" y="114" fill="currentColor" fillOpacity="0.5" fontSize="11" fontFamily="ui-monospace,monospace" letterSpacing="0.12em">HARDWARE</text>
            <path className="pm-flow" d="M168 110 H230" stroke="url(#pf)" strokeWidth="1.4" />
          </g>

          <g className="pm-node">
            <rect className="pm-tile" x="18" y="152" width="150" height="48" rx="8" fill="#101216" stroke="currentColor" strokeOpacity="0.18" />
            ...
            <text className="pm-label" x="74" y="180" fill="currentColor" fillOpacity="0.5" fontSize="11" fontFamily="ui-monospace,monospace" letterSpacing="0.14em">COMPUTE</text>
        ...
        {/* output — sibling AFTER core so .pm-core:hover ~ selectors reach these */}
