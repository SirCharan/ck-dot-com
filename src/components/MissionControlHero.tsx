    ...
    >
      <div className="mx-auto grid max-w-[var(--mc-shell)] items-center gap-10 px-6 py-16 md:px-8 lg:min-h-[calc(100svh-var(--hdr))] lg:grid-cols-12 lg:gap-12 lg:py-10">
        <HeroReveal className="lg:col-span-7">
          <p className="font-mono text-[12px] uppercase tracking-[0.18em] text-[rgb(var(--ash))]">
            <span
              aria-hidden
              className="mr-2 inline-block h-[7px] w-[7px] rounded-full bg-[rgb(var(--ash))] align-middle"
            />
            {RANGE}
          </p>
          <h1 className="mt-4 font-grotesk text-[clamp(2.9rem,7vw,5.5rem)] font-extrabold leading-[0.93] tracking-[-0.035em] text-ink">
            Charandeep Kapoor
          </h1>
          <p className="mt-6 max-w-[46ch] font-serif text-[clamp(1.2rem,2vw,1.6rem)] leading-[1.45] text-ink">
            I build AI that trades markets — <span className="text-ink">and makes money</span>.
          </p>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-x-2 gap-y-1.5 font-mono text-[12.5px] text-[rgb(var(--mute))]">
            <a
              ...
              className="text-ink underline decoration-[rgb(var(--ink)/0.3)] underline-offset-4 transition-colors hover:decoration-[rgb(var(--ink)/0.6)]"
            >
              Timelock
            </a>
          ...
          <nav aria-label="Primary" className="mt-8 flex flex-wrap items-center gap-3">
            <a
              ...
              className="rounded-md bg-[rgb(var(--ink))] px-3.5 py-2 font-mono text-[13px] text-[rgb(var(--bg))] transition-opacity hover:opacity-90"
            >
              Book a call
            </a>
            <a
      ...
      >
        <svg width="20" height="30" viewBox="0 0 20 30" fill="none" className="mc-scrollcue text-[rgb(var(--faint))]">
          ...
          <circle cx="10" cy="9" r="2.5" fill="rgb(var(--faint))" className="mc-scrollcue-dot" />
        </svg>
      </div>
    </section>
  );
