    ...
    <section id="academic" className="py-20">
      <div className="container mx-auto px-4">
            ...
            <div className="glass-card p-6">
              <div className="space-y-6">
                {academics.map((item, index) => (
                  <div 
                    key={index} 
                    className="border-b border-white/10 last:border-b-0 pb-4 last:pb-0 animate-fade-in"
        ...
        <div className="mt-12 glass-card p-6 md:p-8 animate-fade-in">
          <h3 className="text-xl font-semibold text-white mb-4">Mathematical Background</h3>
          <p className="text-gray-300 mb-4">
            My strong foundation in mathematics has been instrumental in my approach to crypto trading and product development. From optimizing algorithms to designing risk models, mathematics has been at the core of my professional journey.
          </p>
          <p className="text-gray-300">
            Ranking 3rd in the National Mathematics Olympiad highlights my aptitude for problem-solving and analytical thinking - skills that I've consistently applied throughout my career in the cryptocurrency and finance sectors.
          </p>
        </div>
      </div>
    </section>
