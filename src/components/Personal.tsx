  ...
  return <section id="personal" className="py-20 bg-crypto-black/80">
      <div className="container mx-auto px-8 md:px-12 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="glass-card p-6 animate-fade-in transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-card">
            <h3 className="text-xl font-semibold font-heading text-white mb-3 flex items-center">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="inline-flex items-center crypto-link">
              <ExternalLink size={16} className="mr-1 icon-hover-animate" strokeWidth={2} />
              <span>View Profile</span>
            </a>
          </div>
          
          <div className="glass-card p-6 animate-fade-in transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-card" style={{
          animationDelay: "100ms"
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center crypto-link">
              <Linkedin size={16} className="mr-1 icon-hover-animate" strokeWidth={2} />
            ...
            <a href="https://twitter.com/yourasianquant" target="_blank" rel="noopener noreferrer" className="inline-flex items-center crypto-link mt-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="mr-1 icon-hover-animate" strokeWidth={2}>
