...
Some bets/predictions for the future.
...
- Time for work ↓, free time ↑
  ...
  - People find real work-life balance, explore other interests
    ...
    - Retreats. Meditation. Find more means for calm & meaning
    - Focussed communities develop
...
- AI enables unlimited content produced based on user's personal tastes and feedback loops, hacks attention, dopamine — large portions of population addicted. (Big opportunity?)
...
- Genetic modifications in food becomes common
  - Cosmetic surgeries, body modifications become common
  - AR/VR gains popularity first, then eye implants, brain-computer interfaces change how we view "screens" (mobiles, laptops etc)

## Green Energy

- Both a forced and much required change
  - Solar dominates, before nuclear takes over (infinite energy?)
