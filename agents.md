...
- **Writings**: Display label "Writings"; route `/blog`. Codex-style nav (Home · Writings · RSS). Prev/next post links. No dates shown. Copy `_template.md` for new posts. Current posts: why-traders-like-losing-90-percent-failure, order-of-things-to-target-money-first, why-ai-cant-replace-a-genius, power-law-average-waste-150-crore-country.
